...
system_name = "amici"  # Out of amici, amicimis, single, singlemis
model_name = "padut"  # Out of dgsmp, mst, dwmt, padut, duf, dauhst
name = f"testing_reconstruction_{system_name}_{model_name}_{datetime.datetime.now().strftime('%Y-%m-%d_%H:%M:%S')}"
...
reconstruction_checkpoint = f"./checkpoints/checkpoints_{model_name}/best-checkpoint_{system_name}_{model_name}.ckpt"
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename=f'best-checkpoint_{system_name}_{model_name}',  # Checkpoint file name
