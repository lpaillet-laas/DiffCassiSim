...
name = f"training_simple_reconstruction_{system_name}_{model_name}_{datetime.datetime.now().strftime('%Y-%m-%d_%H:%M:%S')}"
optics_model_file_path = f"../system_specs/system_{system_name}.yml"

log_dir = 'tb_logs'

train = True
run_on_cpu = True # Set to True if you prefer to run it on cpu
