...
name = f"testing_wrong_reconstruction_{system_name}_{model_name}_{datetime.datetime.now().strftime('%Y-%m-%d_%H:%M:%S')}"
...
reconstruction_checkpoint = f"./checkpoints/checkpoints_{model_name}/best-checkpoint_amiciwrong_{model_name}.ckpt"
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename=f'best-checkpoint_wrong_{system_name}_{model_name}',  # Checkpoint file name
