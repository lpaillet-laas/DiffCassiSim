...
model_name = "dauhst"  # Out of dgsmp, mst, dwmt, padut, duf, dauhst
name = f"training_reconstruction_{system_name}_{model_name}_{datetime.datetime.now().strftime('%Y-%m-%d_%H:%M:%S')}"
