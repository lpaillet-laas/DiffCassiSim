...
data_dir_test = "/data1/lpaillet/do_networks/datasets_reconstruction/mst_datasets/cave_1024_28_test/" # Folder where the test dataset is
...
name = f"training_wrong_reconstruction_amici_{model_name}_{datetime.datetime.now().strftime('%Y-%m-%d_%H:%M:%S')}"
optics_model_file_path = "/data1/lpaillet/do_networks/system_amiciwrong.yml"
...
rays_file = "/data1/lpaillet/do_networks/rays_amiciwrong.pt"
valid_file = "/data1/lpaillet/do_networks/rays_valid_amiciwrong.pt"
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename=f'best-checkpoint_amiciwrong_{model_name}',  # Checkpoint file name
