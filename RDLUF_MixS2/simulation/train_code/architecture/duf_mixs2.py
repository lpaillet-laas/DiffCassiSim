...
class DUF_MixS2(nn.Module):
    def __init__(self, opt, dispersion_pixels, mapping_cube):
        super().__init__()
        self.opt = opt
    ...
    def expand_wav(self, inputs, dispersion_pixels, n_lambda = 28):
        ...
        fake_output = fake_output #[:, :, :256, 256:]
